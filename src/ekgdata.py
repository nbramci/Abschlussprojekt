...
class EKGdata:
    ...
    def find_peaks(self):
        """
        Erkennt die Peaks (Herzschläge) im EKG-Signal anhand der Messwerte.
        """
    ...
    def estimate_hr(self):
        """
        Schätzt die mittlere Herzfrequenz basierend auf den erkannten Peaks.
        """
    ...
    def plot_hr_over_time(self):
        """
        Berechnet die Herzfrequenz über die Zeit und gibt einen Plotly-Plot zurück.
        """
        if not hasattr(self, "peaks"):
